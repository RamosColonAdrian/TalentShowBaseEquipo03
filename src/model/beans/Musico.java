...
public class Musico extends Artista {
     ...
     * @param audios 
     */
    public Musico(String nombre, String apellidos, String localidad, int edad, boolean sexo, AudiosIMPL audios) {
        super(nombre, apellidos, localidad, edad, sexo);
        this.audios = audios;
    }

    /**
     * Metodo que anula el metodo de la clase Padre y que desarrolla la actuacion del Musico
     * @param artista 
